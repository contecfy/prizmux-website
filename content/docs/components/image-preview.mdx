...
| `backdropColor` | `string` | - | Modal backdrop color |
| `textColor` | `string` | - | Header and subtitle text color |
| `headerBackgroundColor` | `string` | - | Header bar background |
| `buttonBackgroundColor` | `string` | - | Nav button background color |
| `loadingColor` | `string` | - | Activity indicator color |
| `style` | `ViewStyle` | - | Wrapper container styles |
| `headerStyle` | `ViewStyle` | - | Header container styles |
| `titleStyle` | `TextStyle` | - | Title text styles |
| `imageStyle` | `ImageStyle` | - | Main image container styles |
| `closeButtonStyle` | `ViewStyle` | - | Close button container styles |
| `navButtonStyle` | `ViewStyle` | - | Next/Prev button styles |
